...
public class Alcohol extends Product {
    ...
    public String finalPrice() {
        String formattedEurPrice = decimalFormat.format(calculatePrice(this.getPrice()+0.89));
        String formattedChfPrice = decimalFormat.format(calculatePrice(getFrankPrice()+0.89));
